<?php 
/* Template Name: Keyboard Research */
get_header(); ?>
...
<div class="servicetitle"><?php the_field('google_penalty_recovery_group_google_penalty_recovery_heading');?></div>
<?php the_field('google_penalty_recovery_group_google_penalty_recovery_content');?>
</div>
		</div>
		<div class="clearfix"></div>
	</div>
