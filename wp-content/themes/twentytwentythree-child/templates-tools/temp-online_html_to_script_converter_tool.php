<?php
/**
 * Template Name: Online HTML to Script Converter tool
 *
...
get_header();
 ?>
 <div class="tool-pages  tool-inner-page html-convert-page">
<section class="mainHexaa customized_tools html_converter_custom">
	<div class="container">
				<div class="robt_main_otr">
					...
					<div class="tool-inn-right">
						<div class="bg_with_border">
					 		<?php include get_stylesheet_directory() . '/templates-tools/seo-tools/html-css/html-to-script/index.php'; ?>
						 </div>	
