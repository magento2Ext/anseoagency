    ...
    function m(a, c) {
        ...
        b.extend(d, {
            load: function (a) {
                ...
                var j = c.top,
                    e = c.left,
                    i = f.outerWidth({ margin: true }),
                    m = f.outerHeight({ margin: true });
        ...
        d.extend(this, {
            click: function (a, h) {
                ...
                if (!h.isDefaultPrevented())
                    return (
                        m[j ? (b.initialEffect && b.effect) || "default" : b.effect].call(e, a, function () {
                            i = a;
                            h.type = "onClick";
                            l.trigger(h, [a]);
                        }),
...
(function () {
    ...
    function l(a, b, c) {
        if (e.isSupported(b.version)) a.innerHTML = e.getHTML(b, c);
        else if (b.expressInstall && e.isSupported([6, 65])) a.innerHTML = e.getHTML(h(b, { src: b.expressInstall }), { MMredirectURL: location.href, MMplayerType: "PlugIn", MMdoctitle: document.title });
        else if (
            (a.innerHTML.replace(/\s/g, "") ||
                ((a.innerHTML =
                    ...
                    (0 < f[0] ? "Your version is " + f : "You have no flash plugin installed") +
                    "</h3>" +
                    ("A" == a.tagName ? "<p>Click here to download latest version</p>" : "<p>Download latest version from <a href='" + j + "'>here</a></p>")),
                "A" == a.tagName &&
                    (a.onclick = function () {
                        location.href = j;
                    })),
    ...
    var i = document.all,
        ...
        n = /(\d+)[^\d]+(\d+)[^\d]*(\d*)/,
        g = { width: "100%", height: "100%", id: "_" + ("" + Math.random()).slice(9), allowfullscreen: !0, allowscriptaccess: "always", quality: "high", version: [3, 0], onFail: null, expressInstall: null, w3c: !1, cachebusting: !1 };
    window.attachEvent &&
    ...
    m &&
        ...
        (jQuery.tools.flashembed = { conf: g }),
        ...
        init: function (c) {
            h ||
                (a.browser.msie && "8" > a.browser.version
                    ? d ||
                      ((d = a("<iframe/>").attr("src", "javascript:false;").hide().get(0)),
                      a("body").append(d),
...
(function (b) {
    ...
    e.addEffect(
        ...
        function (b) {
            var a = this.getConf(),
                g = this.getTip(),
                c = a.slideFade ? { opacity: a.opacity } : {},
