...
/* Template Name: Google penalty recovery */

get_header();?>
<main class="google-penalty-recovery">
...
<section class="seocontent_sec enter-seo" id="seoservices_sec">
...
<section class="seocontent_sec element-enterprise" id="seoservices_sec">
...
<section class="seocontent_sec enterprise" id="seoservices_sec">
 ...
 <section class="seoteam_sec margin-100px team-enterprise" id="seoteam">
...
<section class="seocontent_sec upgrade-enterprise" id="seoservices_sec">
...
$fix_google_penalties_fix_google_image=get_field('fix_google_penalties_fix_google_image');

$fix_google_penalties_fix_google_heading=get_field('fix_google_penalties_fix_google_heading');

$fix_google_penalties_fix_google_content=get_field('fix_google_penalties_fix_google_content');

if(!empty($fix_google_penalties_fix_google_heading) || !empty($fix_google_penalties_fix_google_image) || !empty($fix_google_penalties_fix_google_content)):
...
<section class="seocontent_sec " id="seoservices_sec">
            ...
            echo '<img src="' . esc_url($fix_google_penalties_fix_google_image['url']) . '" alt="' . esc_attr($fix_google_penalties_fix_google_image['alt']) . '">';
			...
			<div class="servicecontentbx fright ptag">
				...
				<h2><?php echo $fix_google_penalties_fix_google_heading;?></h2>

				<?php echo $fix_google_penalties_fix_google_content;?>
...
$ppc_platform_group = get_field('google_penalty_platform_group','option');
...
$service_group = get_field('google_digital_marketing','option'); // Replace 'service_group' with your group field name
