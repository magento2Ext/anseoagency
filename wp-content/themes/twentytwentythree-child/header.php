...
<head>
    ...
    <?php wp_head(); ?> <!-- Required for WordPress plugins and styles -->
...
<header class="desk">
    ...
    <div class="wrapper">
        ...
        <div class="headbtndiv hideinmobile">
            <a href="tel:+91<?php echo get_field('phone_number', 'option'); ?>" class="headphone">
                <i class="fa fa-phone" aria-hidden="true"></i> Call:
                <div class="number-shuffle black-no">
                  <span><?php echo get_field('phone_number', 'option'); ?></span>
                </div>
            </a>
            <button class="btn-theme headproposal wplightbox free_btn_main">
                Free Audit
            </button>
            <button type="button" class="btn-theme headproposal open-modal-btn" id="openTypeform1" 
...
<header class="mob">
    <div class="nav-wrapper">
        ...
        <nav role="navigation" id="mblmnu">
            ...
            <?php
            wp_nav_menu(array(
                'theme_location' => 'primary-menu', // Use the same menu location
                'container' => 'ul',
                'menu_id' => 'menu-primary-menu', // Unique ID for mobile menu
                'menu_class' => '',
                'depth' => 4, // Include sub-menus
                'fallback_cb' => false, // Disable fallback menu
                'walker' => new Mobile_Walker_Nav_Menu(), // Use the same walker
            ));
            ?>
        </nav>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="headbtndiv hideinmobile">
            ...
            <button class="btn-theme headproposal wplightbox btn-seoaudit free_btn_main">
                Free Audit
            </button>
            <button type="button" class="btn-theme headproposal wplightbox open-modal-btn">
                Contact Us
            </button>
        </div>
        <div class="headbtndiv mobileheadbtndiv">
          <button class="btn-theme headproposal wplightbox btn-seoaudit">
            Free Audit
          </button>
  
          <button
            data-tf-popup="it8wWdEj"
            data-tf-iframe-props="title=Get Proposal"
            data-tf-medium="snippet"
            class="btn-theme headproposal wplightbox"
          >
            Get Proposal
          </button>
        </div>
        ...
        class RocketLazyLoadScripts {
          ...
          i(t) {
            "HTML" !== t.target.tagName &&
              ...
              this.L(t.target, !0),
              this.M(t.target, "onclick", "rocket-onclick"),
              this.C());
          }
          o(t) {
            window.removeEventListener("touchend", this.touchEndHandler),
              ...
              this.L(t.target, !1),
              this.M(t.target, "rocket-onclick", "onclick"),
              this.O();
          }
          h() {
            window.removeEventListener("touchend", this.touchEndHandler),
            ...
            (EventTarget.prototype.addEventListenerBase =
              ...
              (EventTarget.prototype.addEventListener = function (e, i, o) {
                "click" !== e ||
                  ...
                  (this || window).addEventListenerBase(e, i, o);
              });
          }
          L(t, e) {
          ...
          async R() {
            (this.lastBreath = Date.now()),
              ...
              this.A(),
              this.I(),
              await this.U(this.delayedScripts.normal),
              await this.U(this.delayedScripts.defer),
              await this.U(this.delayedScripts.async);
            try {
              await this.W(), await this.H(this), await this.J();
            } catch (t) {
              console.error(t);
            }
                      ...
                      i.hasAttribute("src")
                        ? (i.addEventListener("load", o),
                          i.addEventListener("error", function () {
                            i.setAttribute("data-rocket-status", "failed"), e();
                          }),
                          setTimeout(() => {
                            i.isConnected || e();
                          }, 1))
            ...
            function n(e, i) {
              ...
              (e[i] = null),
                Object.defineProperty(e, i, {
                  get: () => o || function () {},
                  set(n) {
                    t.everythingLoaded ? (o = n) : (e["rocket" + i] = o = n);
                  },
                });
            }
          ...
          F(t) {
            ...
            function o(o) {
              if (o && o.fn && !t.allJQueries.includes(o)) {
                ...
                const e = o.fn.on;
                (o.fn.on = o.fn.init.prototype.on =
                  function () {
                    return (
                      this[0] === window &&
          ...
          q() {
            ...
            document.write = document.writeln = function (e) {
              ...
              const o = document.createRange(),
                n = i.parentElement;
              let s = t.get(i);
              void 0 === s && ((s = i.nextSibling), t.set(i, s));
