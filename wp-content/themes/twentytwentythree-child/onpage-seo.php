...
<section class="seoservices_sec margin-100px" id="seoservices_sec">
			...
			$image = get_field('on_seo_page_group_on_seo_page_image');
			...
			<div class="seoservice_infobox ptag">

				<div class="sectiontitle"><?php the_field('on_seo_page_group_on_seo_page_heading');?></div>

				<?php the_field('on_seo_page_group_on_seo_page_content');?>
	...
	<section class="sec_offpage_wrap ptag">

    <div class="wrapper">

        <div class="offpage_wrap">

            <!-- Left Column: Services List -->

            <div class="offpage_left">

                <div class="offpage_lbox">

                    <div class="service_title">

                        <?php 

                        $group = get_field('on_page_services_group'); 

                        if ($group) {

                            echo esc_html($group['on_page_services_group_left_side_heading']);
                    ...
                    <ul class="service_ul">
                        ...
                        if (!empty($group['on_page_seo_services'])) :

                            foreach ($group['on_page_seo_services'] as $service) :
            ...
            <div class="offpage_right">

                <?php 

                if (!empty($group['service_details'])) :

                    foreach ($group['service_details'] as $detail) :
                ...
                ?>
                        ...
                        <div class="sectiontitle"><?php echo esc_html($title); ?></div>
...
<section class="seocontent_sec " id="seoservices_sec">
			...
			$image = get_field('ecommerce_seo_ecommerce_seo_image');
			...
			<div class="servicecontentbx fright ptag">
				...
				<h2><?php the_field('ecommerce_seo_ecommerce_seo_heading');?></h2>

				<?php the_field('ecommerce_seo_ecommerce_seo_content');?></div>
...
<section class="seoprocess_sec margin-100px scroll-view" id="seo_processsection">
		...
		<div class="wrapper">
		    ...
		    <div class="main-seoinsight">
    			...
    			<h3><?php the_field('on_page_seo_process_group_onpage_process_heading');?></h3>
                <div class="main-seoinsight">
    			<div class="semititle"><?php the_field('on_page_seo_process_group_onpage_process_subtitle');?></div>

    			<div class="sec_absolutetxt"><?php the_field('on_page_seo_process_group_onpage_process_content');?></div>
                </div>
			</div>
...
if( have_rows('on_page_seo_process_group') ):

    // Loop through the rows of data in ppc_process_group

    while( have_rows('on_page_seo_process_group') ) : the_row();



        // Check if there are rows in the repeater field

        if( have_rows('onpage_process_repeater') ): ?>
            ...
            <div class="processcont_left scrollbar" id="style-3">
                ...
                <ul class="processlistbox force-overflow scroll-view-tabs" data-active_class="active">
                    ...
                    while( have_rows('onpage_process_repeater') ) : the_row();

                        // Get the subfield values

                        $process_number = get_sub_field('onpage_process_number');

                        $process_text = get_sub_field('onpage_process_text');
        ...
        if( have_rows('onpage_process_repeater') ): ?>
            ...
            <div class="processcont_right scroll-view-tabs-content">
                    ...
                    while( have_rows('onpage_process_repeater') ) : the_row();
                        ...
                        $process_detail_heading = get_sub_field('onpage_process_detail_heading');

                        $process_detail_content = get_sub_field('onpage_process_detail_content');

                        $process_detail_image = get_sub_field('onpage_detail_image');
                	...
                	<div class="processinfo_left ptag">
                           ...
                           <?php echo $process_detail_content; ?>
      ...
      <div class="processaccordioncontainer">
        ...
        <div class="accordion-demo">
          ...
          while (have_rows('onpage_process_repeater')) : the_row(); 
            ...
            $step_number = get_sub_field('onpage_process_number'); // Step Number

            $step_title = get_sub_field('onpage_process_text'); // Step Title

            $step_header = get_sub_field('onpage_process_detail_heading'); // Section Header

            $step_description = get_sub_field('onpage_process_detail_content'); // Description (WYSIWYG)

            $step_image = get_sub_field('onpage_detail_image'); // Image (URL)
...
?>
	...
	<section class="seocontent_sec " id="seoservices_sec">
			...
			<div class="wrapper">
				...
				<div class="servicecontent_div">
					...
					<div class="servicecontentbx fleft ptag">
						...
						<h2><?php the_field('successfull_ecommerce_successfull_ecommerce_heading');?></h2>

						<?php the_field('successfull_ecommerce_successfull_ecommerce_content');?>
			...
			$image = get_field('successfull_ecommerce_sucessfull_ecommerce_image');
    ...
    <div class="wrapper" bis_skin_checked="1">
        ...
        <h3><?php the_field('case_study_heading');?></h3>

        <div class="main-seoinsight">

        <div class="semititle" bis_skin_checked="1"><?php the_field('case_study_subheading');?></div>

        <div class="sec_absolutetxt" bis_skin_checked="1"><?php the_field('case_study_subcontent');?></div>
    ...
    <div class="casestudyslide regular slider" bis_skin_checked="1">
            ...
            <?php while (have_rows('case_study_images')) : the_row(); 
...
<section class="seocontent_sec " id="seoservices_sec">
			...
			$image = get_field('why_choose_anseo_agency_why_anseo_image');
			...
			<div class="servicecontentbx fright ptag">
				...
				<h2><?php the_field('why_choose_anseo_agency_why_anseo_heading');?></h2>

				<?php the_field('why_choose_anseo_agency_why_anseo_content');?></div>
			...
			<div class="wrapper">
				...
				<div class="servicecontent_div">
					...
					<div class="servicecontentbx fleft ptag">
						...
						<h2><?php the_field('advanced_ecommerce_strategy_advanced_ecommerce_heading');?></h2>

						<?php the_field('advanced_ecommerce_strategy_advance_ecommerce_content');?></div>

    					<div class="serviceimgbx fright">

    						<?php

    			$image = get_field('advanced_ecommerce_strategy_advanced_ecommerce_image');
...
<div class="wrapper">
    ...
    <h3><?php the_field('onpage_team_lead_group_team_lead_heading');?></h3>
    <div class="main-seoinsight">
    <div class="semititle ftsz22"><?php the_field('onpage_team_lead_group_team_lead_subheading');?></div>

    <div class="sec_absolutetxt"><?php the_field('onpage_team_lead_group_team_lead_sub_content');?></div>
</div>
        ...
        <div class="teaminfobox">
            ...
            <div class="membernamediv">
                ...
                <dl>
                    ...
                    <dt><?php the_field('onpage_team_lead_group_team_lead_name');?></dt>

                    <dd><span><?php the_field('onpage_team_lead_group_team_lead_specialist');?></span></dd>
            ...
            $image = get_field('onpage_team_lead_group_team_lead_image');
            ...
            ?>
                ...
                <div class="ptag">
                    ...
                    <?php the_field('onpage_team_lead_group_team_lead_content');?>  
...
<section class="seocontent_sec " id="seoservices_sec">
			...
			$image = get_field('ecommerce_seo_mistakes_group_ecommerce_mistakes_image');
			...
			<div class="servicecontentbx fright ptag">
				...
				<h2><?php the_field('ecommerce_seo_mistakes_group_ecommerce_mistakes_heading');?></h2>

				<?php the_field('ecommerce_seo_mistakes_group_ecommerce_mistakes_content');?></div>
...
<section class="blog_sec margin-100px" id="articles">
	...
	<section class="seocontent_sec final-section" id="seoservices_sec">
			...
			<div class="wrapper">
				...
				<div class="servicecontent_div">
					...
					<div class="servicecontentbx fleft ptag">
						...
						<h2><?php the_field('final_thoughts_group_final_thoughts_heading');?></h2>

						<?php the_field('final_thoughts_group_final_thoughts_content');?>
			...
			$image = get_field('final_thoughts_group_final_thoughts_image');
...
$image = get_field('onpage_vs_offpage_onpage_seo_image');

$heading = get_field('onpage_vs_offpage_onpage_seo_heading');

$content = get_field('onpage_vs_offpage_onpage_content');

if ($image || $heading || $content): ?>

    <section class="seocontent_sec ">
			...
			<div class="servicecontentbx fright ptag">
						...
						<h2><?php the_field('onpage_vs_offpage_onpage_seo_heading');?></h2>

					<?php the_field('onpage_vs_offpage_onpage_content');?>	
				...
				<div class="servicecontent_div maketopspacing">
					...
					<div class="servicecontentbx fleft ptag">
						...
						<?php the_field('onpage_ranking_group_onpage_ranking_content');?>
            ...
            $image = get_field('onpage_ranking_group_onpage_ranking_image');
...
<section class="platform_sec margin-100px" id="seo_platform">
    ...
    <h3><?php the_field('onpage_platform_group_onpage_platform_heading');?></h3>
    <div class="main-seoinsight">
    <div class="semititle ftsz22"><?php the_field('onpage_platform_group_onpage_platform_subheading');?></div>

    <div class="sec_absolutetxt"><?php the_field('onpage_platform_group_onpage_platform_content');?></div>
</div>
...
$ppc_platform_group = get_field('onpage_platform_group');



// Check if the group field exists and contains the repeater field

if ($ppc_platform_group && isset($ppc_platform_group['onpage_platform_repeater'])) :

    $platforms = $ppc_platform_group['onpage_platform_repeater'];
    ...
    <div class="ppc-platform-section">
        ...
        foreach ($platforms as $platform) :
            ...
            $image = $platform['onpage_platform_image'] ;

            $service_text = $platform['onpage_service_text'] ;

            $technology = $platform['onpage_platform_technology'] ;

            $url = $platform['onpage_platform_url'] ?? '#'; // Ensure you have the URL field or use a default value
...
<section class="servicepg margin-100px location_list location_sec splloc" id="ourlocation">
    ...
    <div class="wrapper">
        ...
        <h3><?php the_field('onpage_digital_marketing_section_title')?></h3>

        <div class="semititle"><?php the_field('onpage_digital_marketing_section_subtitle')?></div>

        <?php

// Retrieve the group field

$service_group = get_field('onpage_digital_marketing'); // Replace 'service_group' with your group field name



if ($service_group && isset($service_group['onpage_services'])): ?>

    <div class="servicebx_container locationcitycontainer">

        <?php foreach ($service_group['onpage_services'] as $service): 
