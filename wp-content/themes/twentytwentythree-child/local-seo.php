...
$image = get_field('google_penalty_recovery_group_google_penalty_recovery_image');

$heading = get_field('google_penalty_recovery_group_google_penalty_recovery_heading');

$content = get_field('google_penalty_recovery_group_google_penalty_recovery_content');
            ...
            <div class="servicecontent_div nopaddrl">
                ...
                <div class="servicecontentbx fright ptag">
                    ...
                    <?php if ($heading): ?>
                        ...
                        <div class="servicetitle"><?php echo esc_html($heading); ?></div>
...
<section class="seocontent_sec Ultimate-seo-main " id="seoservices_sec">
...
$local_seo_servies_heading= get_field('local_seo_services_heading');

$local_seo_servies_icon= get_field('local_seo_services_icon');

$local_seo_servies_subheading= get_field('local_seo_services_subheading');

$local_seo_servies_content= get_field('local_seo_services_content');

if(!empty($local_seo_servies_heading) || !empty($local_seo_servies_subheading) ||!empty($local_seo_servies_icon) ||!empty($local_seo_servies_content)):
				...
				<div class="offpage_wrap">
					...
					<div class="offpage_left">
						...
						<div class="offpage_lbox">
							...
							<div class="service_title"><?php echo $local_seo_servies_heading ?></div>

							<ul class="service_ul">

								<li><a href="javascript:void(0)"><img src="<?php echo $local_seo_servies_icon['url']?>" class="" alt="Google Business Profile Optimisation" decoding="async"><span><?php echo $local_seo_servies_subheading?></span></a>
					...
					<div class="offpage_right">
												...
												<div class="sectiontitle"><?php echo $local_seo_servies_subheading?></div>

						<p><?php echo $local_seo_servies_content?>
...
<section class="seocontent_sec local-seo-work-stn " id="seoservices_sec">
...
<section class="seoprocess_sec margin-100px scroll-view" id="seo_processsection">
  ...
  <section class="seocontent_sec local-keyword-stn " id="seoservices_sec">
...
<section class="seocontent_sec essentials-stn-main" id="seoservices_sec">
...
$content = get_field('enterprise_seo_landscape');



if (!empty($content)): ?>

    <section class="seocontent_sec landingpg_content ptag">
...
<section class="seocontent_secone-page-seo-stn" id="seoservices_sec">
...
<div class="wrapper">
    ...
    <div class="sec_absolutetxt"><?php the_field('google_team_lead_group_google_team_lead_subcontent');?></div>
            ...
            <div class="membernamediv">
                ...
                <dl>
                 ...
                 <div class="ptag">
                    ...
                    <?php the_field('google_team_lead_group_google_team_lead_content');?>
...
<section class="seocontent_sec local-tools-section" id="seoservices_sec">
...
$heading = get_field('choose_google_penalty_group_choose_google_penalty_heading');

$content = get_field('choose_google_penalty_group_choose_google_penalty_content');
...
if (!empty($heading) || !empty($content) || !empty($image)): ?>
    ...
    <section class="seocontent_sec Final-stn-inn " id="seoservices_sec">
