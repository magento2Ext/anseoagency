<?php 
/* Template Name: International Seo */
get_header(); ?>
...
<?php endif; ?>
<section class="seocontent_sec dominate" id="seoservices_sec">
				<div class="wrapper">
...
<?php
$heading = get_field('common_cause_group_common_cause_heading');
$content = get_field('common_cause_group_common_cause_content');
...
<?php
$heading = get_field('identify_google_penalty_group_identify_google_penalty_heading');
$content = get_field('identify_google_penalty_group_identify_google_penalty_content');
...
<?php
$heading = get_field('google_penalty_group_google_penalty_heading');
$content = get_field('google_penalty_group_google_penalty_content');
...
<?php
$heading = get_field('fix_google_penalties_fix_google_heading');
$content = get_field('fix_google_penalties_fix_google_content');
...
<?php
$awards_text = get_field('awards_text');
$has_award_images = have_rows('award_image');
?>

<?php if ($awards_text || $has_award_images) : ?>
<section class="award_sec margin-100px" id="award_sec">
    <div class="wrapper">
        <div class="award_recogni_sec">
            <?php if ($awards_text) : ?>
                <div class="semititle"><?php echo esc_html($awards_text); ?></div>
            <?php endif; ?>

            <?php if ($has_award_images) : ?>
                <div class="container">
                    <div class="hs__wrapper">
                        <ul class="hs awardcontainer">
                            <?php while (have_rows('award_image')) : the_row(); 
                                $image = get_sub_field('image');
                                if ($image) :
                                    $image_url = esc_url($image['url']);
                                    $image_alt = esc_attr($image['alt'] ?: 'Award image'); 
                            ?>
                                <li class="hs__item">
                                    <div class="awardbox">
